...
public class HistoricFinishedDecisionInstanceReportServiceTest extends AbstractRestServiceTest {
  ...
  private void setupHistoryReportMock() {
    ...
    when(historicFinishedDecisionInstanceReport.count()).thenReturn(mocks);
  }
  ...
  public void testGetReport() {
    ...
    inOrder.verify(historicFinishedDecisionInstanceReport).count();
  }

  @Test
  public void testMissingAuthorization() {
    String message = "not authorized";
    when(historicFinishedDecisionInstanceReport.count()).thenThrow(new AuthorizationException(message));
