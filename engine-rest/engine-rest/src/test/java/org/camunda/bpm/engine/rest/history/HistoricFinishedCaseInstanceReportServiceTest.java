...
public class HistoricFinishedCaseInstanceReportServiceTest extends AbstractRestServiceTest {
  ...
  private void setupHistoryReportMock() {
    ...
    when(historicFinishedCaseInstanceReport.count()).thenReturn(mocks);
  }
  ...
  public void testGetReport() {
    ...
    inOrder.verify(historicFinishedCaseInstanceReport).count();
  }

  @Test
  public void testMissingAuthorization() {
    String message = "not authorized";
    when(historicFinishedCaseInstanceReport.count()).thenThrow(new AuthorizationException(message));
