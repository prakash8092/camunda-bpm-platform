...
public class HistoricDecisionInstanceAuthorizationTest extends AuthorizationTest {
  ...
  public void testHistoryCleanupReportWithAuthorization() {
    ...
    assertEquals(10, reportResults.get(0).getCleanableDecisionInstanceCount().longValue());
    assertEquals(10, reportResults.get(0).getFinishedDecisionInstanceCount().longValue());
  }
